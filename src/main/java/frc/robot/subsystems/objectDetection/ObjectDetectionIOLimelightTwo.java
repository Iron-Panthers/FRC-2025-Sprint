...
public class ObjectDetectionIOLimelightTwo implements ObjectDetectionIO {
  private NetworkTable table = NetworkTableInstance.getDefault().getTable("limelight");

  public ObjectDetectionIOLimelightTwo() {}

  public void updateInputs(ObjectDetectionIOInputsTwo inputs) {
